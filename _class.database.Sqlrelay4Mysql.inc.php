 ...
 */
class Sqlrelay4Mysql extends AbstractDB {
	private $con;
	private $cur;
	private $curpos = 0;
...
select count(*) as rcount from \\2
	...
	public function next(){
		if($this->cur){
			if($this->uppercase){
				return @array_change_key_case(sqlrcur_getRowAssoc($this->cur, $this->curpos++), CASE_UPPER);
			}else{
